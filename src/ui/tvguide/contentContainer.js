...
const RailContainer = ({isFocus, groupId, content, rank, isActive}) => {
        ...
        <div>
            {
                (isFocus && isActive) ?
                    <ContentContainerLayout>
                        <ContentFocus>
                            <ImgLayout
                                src={(content.type === 'channel') ? content.chlogo : Controller.path + content.chlogo}/>
                    ...
                    <ContentContainerUnLayout>
                        ...
                        <YearLayout>
                            <YearUnFocus style={{marginLeft: "20px"}}>{content.group}</YearUnFocus>
                        </YearLayout>
                    </ContentContainerUnLayout>
            }
        </div>
