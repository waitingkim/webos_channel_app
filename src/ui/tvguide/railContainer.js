...
import ContentContainerLayout from "./contentContainer"
...
const RailContainer = ({item, isActive}) => {
    ...
    return (
        <GuideContainerLayout key={item.groupName}>
            <Title key={item.groupName}>
                {
                    (isActive) ? <div style={{display: "flex"}}>
                        <MonthlyTop10 style={{alignItems: "center", marginTop: "0px", opacity:"1.0"}} key={item.groupName}>
                            {item.groupName}
                        </MonthlyTop10>
                        <CountLayout>
                        ...
                        <MonthlyTop10 key={item.groupName} style={{opacity:"0.5"}}>
                            {item.groupName}
                        </MonthlyTop10>
                    </div>
                }
